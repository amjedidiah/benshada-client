...
import $ from "jquery";
import { faStoreAlt, faSearch, faSpinner } from "@fortawesome/free-solid-svg-icons";
...
export default class Search extends Component {
  ...
  search = async (e) => {
    ...
    if (value !== "") {
      $("#searchDropDown").show().html(`<div className="">
          <FontAwesome
        </div>`)
      ...
      <form className="form-inline flex-grow-1 mb-2 mb-md-0">
        <div className="input-group flex-grow-1">
          <div className="dropdown flex-grow-1">
            ...
            />
            <FontAwesomeIcon icon={faSpinner} className="pul" />
