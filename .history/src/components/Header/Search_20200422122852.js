...
export default class Search extends Component {
  ...
  searchFound = () => {
    return <><li className="dropdown-header text-uppercase">
  ...
  searchRenderHelper = () => this.state.relatedProducts === null || this.state.relatedStores === null ? this.searchLoading : serahc
