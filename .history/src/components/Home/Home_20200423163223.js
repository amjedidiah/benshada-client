...
class Home extends React.Component {
  ...
  renderPage() {
    const cats = ["accessories", "bags", "clothes", "shoes"], rand1 = Math.round(Math.random() * 4 + 1),
    rand2 = Math.round(Math.random() * 4 + 1)
    ...
    return (
      <HrFrComp>
        <Jumbo />
        <Gender />
        <Category key={} shortDesc="" longDesc="" reversed={false} category="bags" />
        <Category key={} shortDesc="" longDesc="" reversed={true} category="clothes" />
        <Product
