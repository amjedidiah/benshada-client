...
export default class Products extends Component {
  ...
  componentDidUpdate = () => {
    ...
    return qs.parse(this.props.location.search).id !== this.state.queryString ||
      qs.parse(this.props.location.search).name !==
        this.state.nameQueryString ||
      qs.parse(this.props.location.search).category !==
        this.state.categoryQueryString ||
      qs.parse(this.props.location.search).gender !==
        this.state.genderQueryString
      ? this.helperFunc()
      : "";
  };
