          ...
          <div className="my-2">
            ...
            >
              <div className="container">
                <Link to="/"> Home </Link> /{" "}
                <Link to={`/products/?category=${product[0] && product[0].category}`}> {product[0] && product[0].category} </Link> /{" "}
                <Link to={`/products/?name=${product[0] && product[0].category}`}> {product[0] && product[0].category} </Link> /{" "}
