...
export default class Products extends Component {
  ...
  updateActiveImageURL = (img) => 
    this.setState({ activeImageURL: img.getAttribute("src") });
                  ...
                  <div className="col-12 col-md-6 mb-3 mb-md-0 border border-light px-5 py-3">
                    ...
                    <div className="product-preview">
                      <img
                        ...
                        onclick={this.updateActiveImageURL(http://localhost:3000/img/login.jpg)}
                      />
                      <img
                        alt=""
                        src="http://localhost:3000/img/login.jpg"
  ...
  helperFunc = async () => {
    ...
    this.setState({
      ...
      categoryQueryString,
      genderQueryString,
      activeImageURL: "http://localhost:3000/img/login.jpg",
    });
  };
