...
export default class Products extends Component {
              ...
              <div className="container">
                <div className="row py-4">
                  <div className="col-12 col-md-6 mb-3 mb-md-0 border border-light px-5 py-3">
                    <img alt="" src={activeImageURL} className="img-fluid" />
  ...
  helperFunc = async (aIU) => {
    console.log(this.state.activeImageURL, aIU, "me");
    ...
    this.setState({
      ...
      genderQueryString,
      activeImageURL:
        aIU || (product[0] && product[0].src && product[0].src[0]),
    });
  };
  ...
  componentDidUpdate = () => {
    ...
    qs.parse(this.props.location.search).id !== this.state.queryString || qs.parse(this.props.location.search).name !== this.state.nameQueryString || qs.parse(this.props.location.search).category !== this.state.categoryQueryString ?
      ? this.helperFunc()
      : "";
  };
