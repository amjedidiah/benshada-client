...
export default class Products extends Component {
  ...
  componentDidUpdate = () => {
    ...
    qs.parse(this.props.location.search).id !== this.state.queryString || qs.parse(this.props.location.search).name !== this.state.nameQueryString || qs.parse(this.props.location.search).name !== this.state.nameQueryString
      ? this.helperFunc()
      : "";
  };
