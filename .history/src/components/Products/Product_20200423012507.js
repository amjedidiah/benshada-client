          ...
          return (
            <>
              ...
              >
                <div className="card-body px-3">
                  ...
                  <div className="text-left">
                    ...
                    <button className="btn btn-primary w-100 mt-3" data-toggle="modal" data-target={`productViewModal${i}`}>View</button>
                  </div>
              ...
              <div
                ...
                id={`productViewModal${i}`}
                tabIndex="-1"
                role="dialog"
                aria-labelledby={`productViewModalLabel${i}`}
                aria-hidden="true"
                key={`productViewModal${i}`}
              >
