                ...
                <div className="card-body p-0">
                  <div className="d-flex orders">
                    {products.map(({ name, src }, i) => (
                      <div
                        className="card-img-holder border border-light shadow-sm"
                        key={i}
                      >
                ...
                <div className="modal-dialog modal-xl" role="document">
                  <div className="modal-content">
                    ...
                    <div className="modal-body">
                      {products.map(
                        ({ name, price, discountPercentage }, i) => (
                          <div
                            className="container bg-white p-4 mb-4 text-center d-md-flex shadow-sm"
                            key={i}
                          >
                            {/* <img
                    src={src}
